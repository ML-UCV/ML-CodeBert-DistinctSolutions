...

{
    ...
    for(int i=0; i<n; i++)
        ...
        h2[i] = 1LL*(((i>0)? h2[i-1]: 0) + 1LL*p2[i]*(t[i]-'0'+1) %int(1e9+9))%int(1e9+9);
    ...
    for(int i=0; i<m; i++)
        ...
        hs2 = (1LL*(hs2 + 1LL*p2[i]*(s[i]-'0'+1)%int(1e9+9)))%int(1e9+9);
    ...
    for(int i=m-1; i<n; i++)
        ...
        if( ((1LL*hs*p[i-m+1])%int(1e9+9)) == (1LL*(h[i]- ((i>=m)?h[i-m]:0)+int(1e9+9))%int(1e9+9)) &&
           ...
           ((1LL*hs2*p2[i-m+1])%int(1e9+9)) == (1LL*(h2[i]- ((i>=m)?h2[i-m]:0)+int(1e9+9))%int(1e9+9)))
