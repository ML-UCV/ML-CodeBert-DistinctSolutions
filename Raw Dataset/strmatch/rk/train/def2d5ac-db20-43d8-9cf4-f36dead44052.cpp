...

{
...

    {
        ...
        Hash_a1 = ( Hash_a1 * 80 + ( a[i] - '0' + 1 ) ) % 45007;

        Hash_a2 = ( Hash_a2 * 80 + ( a[i] - '0' + 1 ) ) % 45013;
...

    {
        ...
        Hash1 = ( ( ( Hash1 - ( ( b[i-lg_a] - '0' + 1 ) * P1 ) % 45007 + 45007 ) * 80 ) % 45007 + ( b[i] - '0' + 1 ) ) % 45007;

        Hash2 = ( ( ( Hash2 - ( ( b[i-lg_a] - '0' + 1 ) * P2 ) % 45013 + 45013 ) * 80 ) % 45013 + ( b[i] - '0' + 1 ) ) % 45013;
