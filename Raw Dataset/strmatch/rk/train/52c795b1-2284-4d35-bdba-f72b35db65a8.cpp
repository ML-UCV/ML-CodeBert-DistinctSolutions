...
for(long long i=0; i<m; i++){
    ...
    hb+=(pw*(ord[b[i] ]-ord['a']+1))%(999000000013); hb%=(999000000013);

    pw*=bs; pw%=(999000000013);
...
for(long long i=0; i<m; i++){
    ...
    h2+=(pw2*(ord[a[i] ]-ord['a']+1))%(999000000013); h2%=(999000000013);

    pw2*=bs; pw2%=(999000000013);
...
for(long long i=m; i<n; i++){
    ...
    h2-=(pw1*(ord[a[i-m] ]-ord['a']+1))%(999000000013); h2+=(999000000013); h2+=(pw2*(ord[a[i] ]-ord['a']+1))%(999000000013); h2%=(999000000013);

    pw2*=bs; pw1*=bs; pw1%=(999000000013); pw2%=(999000000013);

    hb*=bs; hb%=(999000000013);
