...
long long closest_dist(pair < int, int > P[100003], int lo, int hi){
    ...
    while(il < nl && ir < nr){
        ...
        if(temp[il].second < temp[ir].second){

            for(int i = ir; (1ll * (temp[il].second - temp[i].second) * (temp[il].second - temp[i].second)) < d && i < nr; i ++){

                d = ((d) < ((1ll * (1ll *(temp[il].first - temp[i].first) * (temp[il].first - temp[i].first) + 1ll *(temp[il].second - temp[i].second) * (temp[il].second - temp[i].second)))) ? (d) : ((1ll * (1ll *(temp[il].first - temp[i].first) * (temp[il].first - temp[i].first) + 1ll *(temp[il].second - temp[i].second) * (temp[il].second - temp[i].second)))));
            ...
            for(int i = il; (1ll * (temp[ir].second - temp[i].second) * (temp[ir].second - temp[i].second)) < d && i < nl; i ++){

                d = ((d) < ((1ll * (1ll *(temp[ir].first - temp[i].first) * (temp[ir].first - temp[i].first) + 1ll *(temp[ir].second - temp[i].second) * (temp[ir].second - temp[i].second)))) ? (d) : ((1ll * (1ll *(temp[ir].first - temp[i].first) * (temp[ir].first - temp[i].first) + 1ll *(temp[ir].second - temp[i].second) * (temp[ir].second - temp[i].second)))));
