...
void interclasare(int n,int m,int mid,int dreapta,long long dist)
...

{
    ...
    long long d1=rezolva(i,mid);

    long long d2=rezolva(mid+1,j);
...

{
   ...
   fout<<fixed<<setprecision(6)<< sqrt(rezolva(0,n-1));
