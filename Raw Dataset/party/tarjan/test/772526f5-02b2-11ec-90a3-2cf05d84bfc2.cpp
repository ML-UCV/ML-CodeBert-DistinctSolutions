...
int I[200010], minI[200010], index, S[200010], inS[200010], t;
int scc_cnt, node_to_scc[200010], scc_in_deg[200010];
vector<int> G[200010], scc_G[200010], scc_list[200010];
...
int main(){
  ...
  static int Q[200010], value[200010];
  vector<int>::iterator ii;
